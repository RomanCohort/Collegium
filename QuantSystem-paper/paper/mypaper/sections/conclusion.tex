...
\begin{enumerate}
    ...
    \item \textbf{Statistical Significance}: Newey-West HAC test yields t-stat = 1.750; two-tailed p-value = 0.085 (marginally significant at 10\%), one-tailed p-value = 0.0425 (significant at 5\% level).
\end{enumerate}
